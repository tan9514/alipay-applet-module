...
namespace Modules\AlipayApplet\Http\Requests\Admin;

use Modules\AlipayApplet\Http\Requests\BaseRequest;

class AlipayAppletTemplateRequest extends BaseRequest
{
    /**
     * 判断用户是否有请求权限
